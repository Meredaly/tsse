<script setup lang="ts">
  ...
  import { Item, HouseholdSociety, HouseholdSocietyData } from '../types'
  ...
  const props = defineProps({
    item: { type: Object as PropType<HouseholdSociety | null>, default: null },
  ...
  const form = ref<HouseholdSocietyData>({
    name: '',
    phoneNumber: '',
    email: '',
    fullAddress: '',
  ...
  const {
    fileData: householdSocietiesLogo,
    uploadFile: uploadHouseholdSocietiesLogo,
    openFile: openHouseholdSocietiesLogo
  } = fileUploader()
  ...
  const save = () => {
    ...
    form.value.logoUuid = householdSocietiesLogo.value.uuid
  ...
  const getData = async (): Promise<void> => {
    ...
    props.item.logo && (householdSocietiesLogo.value = fileDataToForm(props.item.logo))
  }
...
<template>
  <pop-up-body
    @close="close"
    :title="form.uuid ? t('householdSocieties.saveHouseHoldSociety') : t('householdSocieties.addHouseHoldSociety')"
    width="1020"
  >
    <my-row>
      <my-col cols="4">
        <text-field
          ...
          :label="t('householdSocieties.company')"
          :placeholder="t('householdSocieties.names')"
          background
          required
        />
      </my-col>
      <my-col cols="4">
        <text-field
          ...
          :disabled="loading"
          :label="t('householdSocieties.kindOfActivity')"
          :placeholder="t('householdSocieties.kindOfActivity')"
          background
      ...
      <my-col cols="4">
        <text-field
          :label="t('householdSocieties.typeOfProperty')"
          :value="t('householdSocieties.houseHoldSociety')"
          background
          disabled
        />
      </my-col>
      ...
      <my-col cols="4">
        <text-field
          ...
          :disabled="loading"
          :label="t('householdSocieties.phoneNumber')"
          :placeholder="t('householdSocieties.phoneNumber')"
          background
        />
      </my-col>
      <my-col cols="4">
        <text-field
          ...
          :disabled="loading"
          :label="t('householdSocieties.email')"
          :placeholder="t('householdSocieties.email')"
          background
        />
      </my-col>
      <my-col cols="6">
        <dropdown
          ...
          :disabled="loading"
          :label="t('householdSocieties.selectCountry')"
          :placeholder="t('householdSocieties.country')"
          background
          searchable
        />
      </my-col>
      <my-col cols="6">
        <dropdown
          ...
          :label="t('householdSocieties.selectRegionCity')"
          :placeholder="t('householdSocieties.regionCity')"
          background
          searchable
        />
      </my-col>
      <my-col cols="6">
        <text-field
          ...
          :label="t('householdSocieties.fullAddress')"
          :placeholder="t('householdSocieties.address')"
          :disabled="loading"
          background
        />
      </my-col>
      <my-col cols="6">
        <file-uploader
          @change-file="uploadHouseholdSocietiesLogo"
          @open-file="openHouseholdSocietiesLogo"
          :show="householdSocietiesLogo.path"
          :value="householdSocietiesLogo.name"
          :progress="householdSocietiesLogo.progress"
          :disabled="loading"
      ...
      <my-col cols="6">
        <text-field
          ...
          :label="t('householdSocieties.fax')"
          :placeholder="t('householdSocieties.fax')"
          :disabled="loading"
          background
        />
      </my-col>
      <my-col cols="6">
        <text-field
          ...
          :disabled="loading"
          :label="t('householdSocieties.webSite')"
      ...
      <my-col cols="6" class="flex flex-y-end gap-10">
        <text-field
          ...
          :disabled="loading"
          :label="t('householdSocieties.director')"
          :placeholder="t('householdSocieties.director')"
          background
          append-icon="chevronBottom"
          type="button"
        />
      ...
      <my-col cols="6" class="flex flex-y-end gap-10">
        <text-field
          ...
          :value="foundersName"
          :disabled="loading"
          :label="t('householdSocieties.founder')"
          :placeholder="t('householdSocieties.founder')"
          background
          append-icon="chevronBottom"
          type="button"
        />
      ...
      <my-col cols="6">
        <file-uploader
          ...
          :disabled="loading"
          :label="t('householdSocieties.commerceIndustryDetails')"
          :placeholder="t('householdSocieties.selectFile')"
          background
        />
      </my-col>
      <my-col cols="6">
        <file-uploader
          ...
          :disabled="loading"
          :label="t('householdSocieties.certificateOfImplementation')"
          :placeholder="t('householdSocieties.selectFile')"
          background
        />
      </my-col>
      <my-col cols="6">
        <file-uploader
          ...
          :disabled="loading"
          :label="t('householdSocieties.extractOfUsreo')"
          :placeholder="t('householdSocieties.selectFile')"
          background
        />
      </my-col>
      <my-col cols="6">
        <file-uploader
          ...
          :disabled="loading"
          :label="t('householdSocieties.certificateOfStateRegistration')"
          :placeholder="t('householdSocieties.selectFile')"
          background
        />
      </my-col>
      <my-col cols="6">
        <file-uploader
          ...
          :disabled="loading"
          :label="t('householdSocieties.charterOfEnterprise')"
          :placeholder="t('householdSocieties.selectFile')"
          background
        />
      </my-col>
      <my-col cols="6">
        <file-uploader
          ...
          :disabled="loading"
          :label="t('householdSocieties.paymentOrder')"
          :placeholder="t('householdSocieties.selectFile')"
          background
        />
      </my-col>
  ...
  <teleport to="#pop-up">
    <pop-up-select-checkbox
      ...
      :title="t('householdSocieties.kindOfActivity')"
    />
    <pop-up-select
      @save="selectDirector"
      ...
      searchable
      :title="t('householdSocieties.director')"
    />
    <pop-up-individual
    ...
    <pop-up-select-checkbox
      ...
      :title="t('householdSocieties.founder')"
      searchable
    />
  </teleport>
</template>
