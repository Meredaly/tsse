<script setup lang="ts">
  ...
  import { Item, PrivacyCompany, PrivacyCompanyData } from '../types'
  ...
  const props = defineProps({
    item: { type: Object as PropType<PrivacyCompany | null>, default: null },
  ...
  const form = ref<PrivacyCompanyData>({
    name: '',
    phoneNumber: '',
    email: '',
    fullAddress: '',
  ...
  const {
    fileData: privateCompaniesLogo,
    uploadFile: uploadPrivateCompaniesLogo,
    openFile: openPrivateCompaniesLogo
  } = fileUploader()
  ...
  const save = () => {
    ...
    form.value.logoUuid = privateCompaniesLogo.value.uuid
  ...
  const getData = async (): Promise<void> => {
    ...
    props.item.logo && (privateCompaniesLogo.value = fileDataToForm(props.item.logo))
  }
...
<template>
  <pop-up-body
    @close="close"
    :title="form.uuid ? t('privateCompanies.savePrivacyCompanies') : t('privateCompanies.addPrivacyCompanies')"
    width="1020"
  >
    <my-row>
      <my-col cols="4">
        <text-field
          ...
          :label="t('privateCompanies.company')"
          :placeholder="t('privateCompanies.title')"
          background
          required
        />
      </my-col>
      <my-col cols="4">
        <text-field
          ...
          :disabled="loading"
          :label="t('privateCompanies.kindOfActivity')"
          :placeholder="t('privateCompanies.kindOfActivity')"
          background
      ...
      <my-col cols="4">
        <text-field
          :label="t('privateCompanies.typeOfProperty')"
          :value="t('privateCompanies.privateEnterprices')"
          background
          disabled
        />
      </my-col>
      ...
      <my-col cols="4">
        <text-field
          ...
          :disabled="loading"
          :label="t('privateCompanies.phone')"
          :placeholder="t('privateCompanies.phone')"
          background
        />
      </my-col>
      <my-col cols="4">
        <text-field
          ...
          :disabled="loading"
          :label="t('privateCompanies.email')"
          :placeholder="t('privateCompanies.email')"
          background
        />
      </my-col>
      <my-col cols="6">
        <dropdown
          ...
          :disabled="loading"
          :label="t('privateCompanies.selectCountry')"
          :placeholder="t('privateCompanies.country')"
          background
          searchable
        />
      </my-col>
      <my-col cols="6">
        <dropdown
          ...
          :label="t('privateCompanies.selectRegionCity')"
          :placeholder="t('privateCompanies.regionCity')"
          background
          searchable
        />
      </my-col>
      <my-col cols="6">
        <text-field
          ...
          :label="t('privateCompanies.fullAddress')"
          :placeholder="t('privateCompanies.address')"
          :disabled="loading"
          background
        />
      </my-col>
      <my-col cols="6">
        <file-uploader
          @change-file="uploadPrivateCompaniesLogo"
          @open-file="openPrivateCompaniesLogo"
          :show="privateCompaniesLogo.path"
          :value="privateCompaniesLogo.name"
          :progress="privateCompaniesLogo.progress"
          :disabled="loading"
      ...
      <my-col cols="6" class="flex flex-y-end gap-10">
        <text-field
          ...
          :disabled="loading"
          :label="t('privateCompanies.director')"
          :placeholder="t('privateCompanies.director')"
          background
          append-icon="chevronBottom"
          type="button"
        />
      ...
      <my-col cols="6" class="flex flex-y-end gap-10">
        <text-field
          ...
          :value="foundersName"
          :disabled="loading"
          :label="t('privateCompanies.founder')"
          :placeholder="t('privateCompanies.founder')"
          background
          append-icon="chevronBottom"
          type="button"
        />
      ...
      <my-col cols="6">
        <file-uploader
          ...
          :disabled="loading"
          :label="t('privateCompanies.commerceIndustryDetails')"
          :placeholder="t('privateCompanies.selectFile')"
          background
        />
      </my-col>
      <my-col cols="6">
        <file-uploader
          ...
          :disabled="loading"
          :label="t('privateCompanies.certificateOfImplementation')"
          :placeholder="t('privateCompanies.selectFile')"
          background
        />
      </my-col>
      <my-col cols="6">
        <file-uploader
          ...
          :disabled="loading"
          :label="t('privateCompanies.extractOfUsreo')"
          :placeholder="t('privateCompanies.selectFile')"
          background
        />
      </my-col>
      <my-col cols="6">
        <file-uploader
          ...
          :disabled="loading"
          :label="t('privateCompanies.certificateOfStateRegistration')"
          :placeholder="t('privateCompanies.selectFile')"
          background
        />
      </my-col>
      <my-col cols="6">
        <file-uploader
          ...
          :disabled="loading"
          :label="t('privateCompanies.charterOfEnterprise')"
          :placeholder="t('privateCompanies.selectFile')"
          background
        />
      </my-col>
      <my-col cols="6">
        <file-uploader
          ...
          :disabled="loading"
          :label="t('privateCompanies.paymentOrder')"
          :placeholder="t('privateCompanies.selectFile')"
          background
        />
      </my-col>
  ...
  <teleport to="#pop-up">
    <pop-up-select-checkbox
      ...
      :title="t('privateCompanies.kindOfActivity')"
    />
    <pop-up-individual
    ...
    <pop-up-select
      ...
      :title="t('privateCompanies.director')"
      searchable
    />
    <pop-up-select-checkbox
      @save="selectFounder"
      ...
      :title="t('privateCompanies.founder')"
      searchable
    />
  </teleport>
</template>
